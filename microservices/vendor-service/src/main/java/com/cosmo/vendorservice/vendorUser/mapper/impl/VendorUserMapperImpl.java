package com.cosmo.vendorservice.vendorUser.mapper.impl;
...
public class VendorUserMapperImpl implements VendorUserMapper {
    ...
    public Vendor dtoToEntity(VendorUserRequestDto vendorUserRequestDto) {
        ...
        if (vendorUserRequestDto.getStatusId() != null) {
            ...
            throw new BadRequestException("StatusId cannot be null");
        }
        if(vendorUserRequestDto.getAccessGroupId() !=null){
            ...
            throw new BadRequestException("AccessGroupId cannot be null");
        }
    ...
    public VendorUserResponseDto entityToDto(Vendor vendor) {
        if (vendor == null) {
            throw new ResourceNotFoundException("VendorUser does not exist");
        }
    ...
    public Vendor updateEntityFromDto(VendorUserRequestDto vendorUserRequestDto, Vendor existingVendor) {
        if (vendorUserRequestDto == null) {
            throw new IllegalArgumentException("VendorUserRequestDto cannot be null");
        }
